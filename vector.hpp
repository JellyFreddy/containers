...
namespace ft {
	...
	public:
		...
		typedef vector_iterator<T, std::random_access_iterator_tag, std::ptrdiff_t, pointer, reference, false>              iterator;
		typedef vector_iterator<T, std::random_access_iterator_tag, std::ptrdiff_t,  pointer, reference, true>        		const_iterator;
